    ...
    <section>
        <div class="banner">
            ...
            <div class="content">
                ...
                <br><br><br><br>
                <h2>I'm a Good Boy like Santino Marella</h2>
                <br>
                <h4>Sleeping&nbsp;&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;&nbsp;Sleeping&nbsp;&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;&nbsp;Sleeping</h4>
            </div>
        </div>
    </section>
    <section>
    ...
    <section>
        <div class="feature-gallery">
            <div class="features1">
                ...
                <h2>ABOUT ME</h2>
                <br>
                <h4>Hi, I'm Richard a Bisaya student from NU Fairview, currently at 2nd year in IT field. <br>As the only boy in the siblings  im only the handsome son of Mr. Nelson and Flor Bonajos <br></h4>
                <h5>"So clean, So good SOGO."</h5>
            </div>
            <div class="div-gallery">
                <div class="drawing-image"><img src="1.jpg" alt="image-1"></div>
                <div class="drawing-image"><img src="2.jpg" alt="image-2"></div>
                <div class="drawing-image"><img src="3.jpg" alt="image-3"></div>
            </div>
    </section>
    <footer>
